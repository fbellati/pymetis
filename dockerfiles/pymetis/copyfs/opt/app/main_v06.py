...
def index():
    ...
    if request.method == 'POST':
        ...
        colors = [
            'red', 'green', 'orange', 'purple', 'brown', 'pink', 'gray', 'olive',
            'magenta', 'yellow', 'black', 'white', 'lime', 'maroon', 'teal', 'aqua', 'fuchsia',
            'gold', 'silver', 'coral', 'indigo', 'khaki', 'lavender', 'plum', 'salmon', 'tan', 'violet',
            'wheat', 'crimson', 'beige', 'chartreuse', 'chocolate', 'cyan', 'ivory', 'mint', 'peach',
            'periwinkle', 'rose', 'sienna', 'turquoise', 'amber', 'emerald'
        ]
